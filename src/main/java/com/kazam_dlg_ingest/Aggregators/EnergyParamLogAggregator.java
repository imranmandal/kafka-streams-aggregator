...
import com.kazam_dlg_ingest.serder.EnergyParamAggSerde;
import com.kazam_dlg_ingest.serder.EnergyParamSerde;
...
public class EnergyParamLogAggregator {
    ...
    public void aggregate() {
        ...
        // StreamKeyUtil streamKeyUtil = new StreamKeyUtil(energyParam.comb_id,
        // energyParam.org,
        // energyParam.timestamp,
        // utcOffsetSeconds, this.boundaryUnit);
        ...
        // if (boundaries.startTime - (energyParam.prevEnergyParamPkt.timestamp * 1000)
        // > 10000) {
        // int diff = 2;
        ...
        // double energy_import_delta_split = energyParam.energy_active_import_delta /
        // diff;
        // double energy_export_delta_split = energyParam.energy_active_export_delta /
        // diff;
        ...
        aggregated
                ...
                .to(this.outputTopic, Produced.with(Serdes.String(), new EnergyParamAggSerde(this.topologyStages)));
    }
}