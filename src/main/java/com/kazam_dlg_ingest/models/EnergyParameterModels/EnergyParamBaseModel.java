...
public class EnergyParamBaseModel extends DlgPacketBaseModel {
    ...
    public EnergyParamBaseModel(JsonNode pkt) {
        ...
        try {
            ...
            if (appEnergyExportJsonNode != null && !appEnergyExportJsonNode.isNull()) {
            ...
            if (appEnergyImportJsonNode != null && !appEnergyImportJsonNode.isNull()) {
