...
public class EnergyParamAggMinMaxTopology {
    ...
    public EnergyParamAggMinMaxTopology(EnergyParamAggTopology acc, EnergyParamBaseModel curr) {
        ...
        for (String param : parameters.SecureMeterEnergyParamsMap) {
            ...
            Double accParamValue = (accDurationLogAggJsonNode.get(param) != null)
                    ? accDurationLogAggJsonNode.get(param).asDouble()
                    : 0;
            Double accParamCount = (accDurationLogAggJsonNode.get(param + "_count") != null)
            ...
            Double accParamMinValue = (accDurationLogAggJsonNode.get(param + "_min") != null)
                    ? accDurationLogAggJsonNode.get(param + "_min").asDouble()
                    : null;
            Double accParamMaxValue = (accDurationLogAggJsonNode.get(param + "_max") != null)
                    ? accDurationLogAggJsonNode.get(param + "_max").asDouble()
                    : null;

            Double currParamValue = (currDataJson.get(param) != null && currDataJson.get(param).isNumber())
                    ? currDataJson.get(param).asDouble()
                    : 0;
            Double currParamDeltaValue = (currDataJson.get(param + "_delta") != null
            ...
            Double currPrevEnergyParamPktParamValue = (currPrevEnergyParamPkt != null
                    && currPrevEnergyParamPkt.get(param) != null)
